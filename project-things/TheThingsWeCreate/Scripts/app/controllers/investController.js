...
myAppModule.controller('InvestController', ['$scope', '$window', '$rootElement', '$location', '$sce', '$routeParams', 'defaultService',
function ($scope, $window, $rootElement, $location, $sce, $routeParams, defaultService) {
    ...
    document.title = "ThingsWeCreate - Investment Opportunity";
