...
myAppModule.controller('WholesaleController', ['$scope', '$window', '$rootElement', '$location', '$sce', '$routeParams', 'defaultService',
function ($scope, $window, $rootElement, $location, $sce, $routeParams, defaultService) {
    ...
    document.title = "ThingsWeCreate - Wholesale Purchase";
