...
myAppModule.controller('LicensingController', ['$scope', '$window', '$rootElement', '$location', '$sce', '$routeParams', 'defaultService',
function ($scope, $window, $rootElement, $location, $sce, $routeParams, defaultService) {
    ...
    document.title = "ThingsWeCreate - Licensing Option";
